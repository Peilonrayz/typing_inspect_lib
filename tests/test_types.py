...
class BaseTestCase(TestCase):
    ...
    def type_test_2(self, type_, typing_, class_, is_, args=None, parameters=None):
        ...
        if is_ is typing_inspect_lib.ClassVar_:
            self.assertTrue(is_ is typing_inspect_lib.get_special_type(type_))
        else:
            self.assertEqual(is_, typing_inspect_lib.get_special_type(type_))
        self.assertEqual(t, typing_inspect_lib.build_types(type_))

    def class_test(self, type_, typing_, class_, is_, t_args=None, args=None, parameters=None, start=0, stop=_STOP, obj=2, fn=lambda i, j: i >= j):
...
class SpecialTestCase(BaseTestCase):
    ...
    def test_callable(self):
        self.type_test_2(typing.Callable, typing.Callable, _abc.Callable, typing.Callable, [])
        self.type_test_2(typing.Callable[[TKey], TValue], typing.Callable, _abc.Callable, typing.Callable, [TKey, TValue], [TKey, TValue])

    @skipIf(PY35 and VERSION <= (3, 5, 2),
            'ClassVar not in 3.5.[0,2]')
    def test_class_var(self):
        self.type_test_2(typing.ClassVar, typing.ClassVar, typing.ClassVar, typing.ClassVar, [])
        self.type_test_2(typing.ClassVar[TValue], typing.ClassVar, typing.ClassVar, typing.ClassVar, [TValue], [TValue])
    ...
    def test_optional(self):
        self.type_test_2(typing.Optional, typing.Optional, typing.Optional, typing.Optional, [])
        self.type_test_2(typing.Optional[TValue], typing.Union, typing.Union, typing.Union, [TValue, type(None)], [TValue])
...
class ABCTestCase(BaseTestCase):
    def test_abstract_set(self):
        self.class_test(typing.AbstractSet, typing.AbstractSet, _abc.Set, None, [TValue], [int], [T_co])

    def test_byte_string(self):
        self.class_test(typing.ByteString, typing.ByteString, _abc.ByteString, None)

    def test_container(self):
        self.class_test(typing.Container, typing.Container, _abc.Container, None, [TValue], [int], [T_co])

    @skipIf(PY35 and VERSION <= (3, 5, 3),
            'ContextManager not in 3.5.[0,3]')
    def test_context_manager(self):
        self.class_test(typing.ContextManager, typing.ContextManager, _abc.AbstractContextManager, None, [TValue], [int], [T_co])
    ...
    def test_items_view(self):
        if PY35 and VERSION <= (3, 5, 1):
            self.type_test_2(typing.ItemsView, typing.ItemsView, _abc.ItemsView, None, [], [T_co, KT, VT_co])
            self.type_test_2(typing.ItemsView[TKey, TValue, TReturn], typing.ItemsView, _abc.ItemsView, None, [TKey, TValue, TReturn], [TKey, TValue, TReturn])
        else:
            self.type_test_2(typing.ItemsView, typing.ItemsView, _abc.ItemsView, None, [], [KT, VT_co])
            self.type_test_2(typing.ItemsView[TKey, TValue], typing.ItemsView, _abc.ItemsView, None, [TKey, TValue], [TKey, TValue])

    def test_iterable(self):
        self.class_test(typing.Iterable, typing.Iterable, _abc.Iterable, None, [TValue], [int], [T_co])

    def test_iterator(self):
        self.class_test(typing.Iterator, typing.Iterator, _abc.Iterator, None, [TValue], [int], [T_co])

    def test_keys_view(self):
        self.class_test(typing.KeysView, typing.KeysView, _abc.KeysView, None, [TKey], [int], [KT])

    def test_mapping(self):
        self.class_test(typing.Mapping, typing.Mapping, _abc.Mapping, None, [TKey, TValue], [int, str], [KT, VT_co], fn=eq)

    def test_mapping_view(self):
        self.class_test(typing.MappingView, typing.MappingView, _abc.MappingView, None, [TKey], [int], [T_co])

    def test_mutable_mapping(self):
        self.class_test(typing.MutableMapping, typing.MutableMapping, _abc.MutableMapping, None, [TKey, TValue], [int, str], [KT, VT], fn=eq)

    def test_mutable_sequence(self):
        self.class_test(typing.MutableSequence, typing.MutableSequence, _abc.MutableSequence, None, [TValue], [int], [T])

    def test_mutable_set(self):
        self.class_test(typing.MutableSet, typing.MutableSet, _abc.MutableSet, None, [TValue], [int], [T])

    def test_sequence(self):
        self.class_test(typing.Sequence, typing.Sequence, _abc.Sequence, None, [TValue], [int], [T_co])

    def test_sized(self):
        self.class_test(typing.Sized, typing.Sized, _abc.Sized, None)

    def test_values_view(self):
        self.class_test(typing.ValuesView, typing.ValuesView, _abc.ValuesView, None, [TValue], [str], [VT_co])

    @skipIf(VERSION < (3, 5, 2), 'Awaitable requires Python 3.5.2')
    def test_awaitable(self):
        self.class_test(typing.Awaitable, typing.Awaitable, _abc.Awaitable, None, [TValue], [int], [T_co])

    @skipIf(VERSION < (3, 5, 2), 'AsyncIterator requires Python 3.5.2')
    def test_async_iterator(self):
        self.class_test(typing.AsyncIterator, typing.AsyncIterator, _abc.AsyncIterator, None, [TValue], [int], [T_co])

    @skipIf(VERSION < (3, 5, 2), 'AsyncIterable requires Python 3.5.2')
    def test_async_iterable(self):
        self.class_test(typing.AsyncIterable, typing.AsyncIterable, _abc.AsyncIterable, None, [TValue], [int], [T_co])

    @skipIf(VERSION < (3, 5, 3), 'Coroutine requires Python 3.5.3')
    def test_coroutine(self):
        self.class_test(typing.Coroutine, typing.Coroutine, _abc.Coroutine, None, [TKey, TSend, TReturn], [int, str, str], [T_co, T_contra, V_co], fn=eq)

    @skipIf(VERSION < (3, 6, 0), 'Collection requires Python 3.6')
    def test_collection(self):
        self.class_test(typing.Collection, typing.Collection, _abc.Collection, None, [TValue], [int], [T_co])

    @skipIf(VERSION < (3, 6, 1), 'AsyncGenerator requires Python 3.6.1')
    def test_async_generator(self):
        self.class_test(typing.AsyncGenerator, typing.AsyncGenerator, _abc.AsyncGenerator, None, [TKey, TSend], [int, str], [T_co, T_contra], fn=eq)
    ...
    def test_async_context_manager(self):
        self.class_test(typing.AsyncContextManager, typing.AsyncContextManager, _abc.AbstractAsyncContextManager, None, [TValue], [int], [T_co])


class ProtocolsTestCase(BaseTestCase):
    def test_reversible(self):
        self.class_test(typing.Reversible, typing.Reversible, _abc.Reversible, None, [TValue], [int], [T_co])

    def test_supports_abs(self):
        self.class_test(typing.SupportsAbs, typing.SupportsAbs, typing.SupportsAbs, None, parameters=[T_co])
    ...
    def test_supports_round(self):
        self.class_test(typing.SupportsRound, typing.SupportsRound, typing.SupportsRound, None, parameters=[T_co])
...
class CollectionTestCase(BaseTestCase):
    ...
    def test_counter(self):
        self.class_test(typing.Counter, typing.Counter, collections.Counter, None, [TValue], [int], [T])
    ...
    def test_chain_map(self):
        self.class_test(typing.ChainMap, typing.ChainMap, collections.ChainMap, None, [TKey, TValue], [int, str], [KT, VT], fn=eq)

    @skipIf((PY35 and VERSION <= (3, 5, 3)) or VERSION == (3, 6, 0),
            'Deque not in 3.5.[0,3] or 3.6.0')
    def test_deque(self):
        self.class_test(typing.Deque, typing.Deque, collections.deque, None, [TValue], [int], [T])

    def test_dict(self):
        self.class_test(typing.Dict, typing.Dict, dict, None, [TKey, TValue], [int, str], [KT, VT], fn=eq)

    @skipIf((PY35 and VERSION <= (3, 5, 1)),
            'DefaultDict not in 3.5.[0,1]')
    def test_default_dict(self):
        self.class_test(typing.DefaultDict, typing.DefaultDict, collections.defaultdict, None, [TKey, TValue], [int, str], [KT, VT], fn=eq)

    def test_list(self):
        self.class_test(typing.List, typing.List, list, None, [TValue], [int], [T])

    def test_set(self):
        self.class_test(typing.Set, typing.Set, set, None, [TValue], [int], [T])

    def test_frozen_set(self):
        self.class_test(typing.FrozenSet, typing.FrozenSet, frozenset, None, [TValue], [int], [T_co])
    ...
    def test_ordered_dict(self):
        self.class_test(typing.OrderedDict, typing.OrderedDict, collections.OrderedDict, None, [TKey, TValue], [int, str], [KT, VT], fn=eq)

    def test_generator(self):
        self.class_test(typing.Generator, typing.Generator, _abc.Generator, None, [TValue, TSend, TReturn], [int, str, str], [T_co, T_contra, V_co], fn=eq)
...
class ExtensionsTestCase(BaseTestCase):
    ...
    # Special
    def test_class_var(self):
        self.type_test_2(typing_extensions.ClassVar, typing_extensions.ClassVar, typing_extensions.ClassVar, typing_extensions.ClassVar, [])
        self.type_test_2(typing_extensions.ClassVar[TValue], typing_extensions.ClassVar, typing_extensions.ClassVar, typing_extensions.ClassVar, [TValue], [TValue])

    def test_type(self):
        self.class_test(typing_extensions.Type, typing_extensions.Type, type, typing_extensions.Type, [TValue], [int], [CT_co])

    # ABCs
    def test_context_manager(self):
        self.class_test(typing_extensions.ContextManager, typing_extensions.ContextManager, _abc.AbstractContextManager, None, [TValue], [int], [T_co])

    @skipIf(VERSION < (3, 5, 0), 'te.Awaitable requires Python 3.5')
    def test_awaitable(self):
        self.class_test(typing_extensions.Awaitable, typing_extensions.Awaitable, _abc.Awaitable, None, [TValue], [int], [T_co])

    @skipIf(VERSION < (3, 5, 0), 'te.AsyncIterator requires Python 3.5')
    def test_async_iterator(self):
        self.class_test(typing_extensions.AsyncIterator, typing_extensions.AsyncIterator, _abc.AsyncIterator, None, [TValue], [int], [T_co])

    @skipIf(VERSION < (3, 5, 0), 'te.AsyncIterable requires Python 3.5')
    def test_async_iterable(self):
        self.class_test(typing_extensions.AsyncIterable, typing_extensions.AsyncIterable, _abc.AsyncIterable, None, [TValue], [int], [T_co])
    ...
    def test_coroutine(self):
        ...
        self.class_test(typing_extensions.Coroutine, typing_extensions.Coroutine, _abc.Coroutine, None, [TKey, TSend, TReturn], [int, str, str], parameters, fn=eq)

    @skipIf(VERSION < (3, 6, 0), 'te.AsyncGenerator requires Python 3.6')
    def test_async_generator(self):
        self.class_test(typing_extensions.AsyncGenerator, typing_extensions.AsyncGenerator, _abc.AsyncGenerator, None, [TKey, TSend], [int, str], [T_co, T_contra], fn=eq)

    @skipIf(VERSION < (3, 5, 0), 'te.AsyncContextManager requires Python 3.5')
    def test_async_context_manager(self):
        self.class_test(typing_extensions.AsyncContextManager, typing_extensions.AsyncContextManager, _abc.AbstractAsyncContextManager, None, [TValue], [int], [T_co])

    @skipIf(VERSION < (3, 3, 0), 'te.ChainMap requires Python 3.3')
    def test_chain_map(self):
        self.class_test(typing_extensions.ChainMap, typing_extensions.ChainMap, collections.ChainMap, None, [TKey, TValue], [int, str], [KT, VT], fn=eq)

    # collection
    def test_counter(self):
        self.type_test_2(typing_extensions.Counter, typing_extensions.Counter, collections.Counter, None, [], [T])
        if PY35 and VERSION <= (3, 5, 1):
            self.type_test_2(typing_extensions.Counter[TValue], typing_extensions.Counter, collections.Counter, None, [TValue, int], [TValue])
        else:
            self.type_test_2(typing_extensions.Counter[TValue], typing_extensions.Counter, collections.Counter, None, [TValue], [TValue])

    def test_deque(self):
        self.class_test(typing_extensions.Deque, typing_extensions.Deque, collections.deque, None, [TValue], [int], [T])

    def test_default_dict(self):
        self.class_test(typing_extensions.DefaultDict, typing_extensions.DefaultDict, collections.defaultdict, None, [TKey, TValue], [int, str], [KT, VT], fn=eq)
